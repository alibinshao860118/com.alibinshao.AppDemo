...
public class MenuTreeService implements ITreeService {
	...
	private SysMenuService sysMenuService2;
	...
	private void buildTreeNodes(String parentId,boolean withSelf, boolean findRoot, List<Map<String, Object>> ret){
		...
		List<SysMenu> menuList = sysMenuService2.findList(entity);
	...
	public SysMenuService getSysMenuService2() {
		return sysMenuService2;
	}

	public void setSysMenuService2(SysMenuService sysMenuService2) {
		this.sysMenuService2 = sysMenuService2;
	}
