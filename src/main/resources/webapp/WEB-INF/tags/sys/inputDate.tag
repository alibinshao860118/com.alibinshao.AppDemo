...
<%@ attribute name="istime" type="java.lang.Boolean" required="false" description="istime"%>
<%@ attribute name="format" type="java.lang.String" required="false" description="format"%>
...
<input type="text" id="${id}" name="${id}" autocomplete="off" value="${value}"
	...
	onFocus="laydate({istime: ${empty istime?'false':istime}, format: '${format}'})">
</c:if>
