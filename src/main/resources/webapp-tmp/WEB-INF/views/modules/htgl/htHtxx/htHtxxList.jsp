...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctxStatic}/js/modules/htgl/htHtxx/htHtxxList.js"></script>
	</head>
	<body>
		...
		<sys:toolbar showExportExcel="true" exportFileName="合同信息表数据列表"
			...
			<div class="layui-btn-group">
				<sys:button onclick="add();" btnClass="layui-btn-small layui-btn-normal"><i class='layui-icon'>&#xe654;</i>新签</sys:button>
