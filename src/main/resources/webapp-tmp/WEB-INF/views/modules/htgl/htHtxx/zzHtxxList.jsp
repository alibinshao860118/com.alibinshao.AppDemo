	...
	<body>
		...
		<sys:toolbar showExportExcel="true" exportFileName="合同信息表数据列表"
			...
			<div class="layui-btn-group">
				<sys:button onclick="edit('0');" btnClass="layui-btn-small layui-btn-danger"><i class='layui-icon'>&#xe640;</i>终止</sys:button>
				<sys:button onclick="edit('1');" btnClass="layui-btn-small layui-btn-normal"><i class='layui-icon'>&#xe642;</i>还原</sys:button>
			</div>
		</sys:toolbar>
