...
$(document).ready(function () {
	$("#dbxx").datagrid({
		url:'<%=ctx%>/zp/zpjlsxlc/queryDbrwByPage.do',
		height : 300,
		singleSelect : true,
		rownumbers:true,
		pagination:true,
...
function formatOperation(value,row, index){
	return "<a href='javascript:void(0)'  class='btn1 btn_01' onclick='dbcl(\""+row.id+"\")' >处理&nbsp;</a>"
		;
}
...
function dbcl(id){
	location.href="<%=ctx%>/zp/zpjlsxlc/jianlisxlcgl_cl.do?id="+id;
}
	...
	<table id="dbxx" style="width: 100%;" >
		<thead>
			<tr>
				...
				<th data-options="field:'czjd', halign:'center',width:100,formatter:formatOperationHj">环节</th>
				<th data-options="field:'blsj', halign:'center',align:'center',width:150">发起时间</th>
