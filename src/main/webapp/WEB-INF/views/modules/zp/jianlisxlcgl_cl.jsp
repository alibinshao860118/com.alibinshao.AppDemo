...
function formatOperation(value,row, index){
	return "<a href='javascript:void(0)'  class='btn1 btn_01' onclick='jianlidy(\""+value+"\")' title='查看简历'>查看简历</a>&nbsp;&nbsp;"
		+"<a href='javascript:void(0)'  class='btn1 btn_01' onclick='openSxyjtjDialog(\""+value+"\")' title='筛选意见'>筛选</a>&nbsp;&nbsp;"
...
function saveSxyj(){
 ...
 function openTjDialog(){
	 var czyj = $("#lcxxForm #czyj").val();
	 var isValid = czyj.length>0?true:false;
	 if(isValid==true){
	 	$('#tjDialog').dialog('open');
	 }else{
		 $.messager.alert({title:'提醒',msg:"请填写筛选意见!"});
	 }
 }
 ...
 function process_submit(){
	 ...
	 var blr =$("#blr").val();
	 var isEnd=(blr.length>0)?true:false;
	 //提交状态赋值
	 if(hjID=='3'){
	 	$("#zt").val("3");
	 	isEnd=true;
...
<div id="tt" class="easyui-tabs" style="width:100%;" data-options="">   
    <div title="表单 " style="padding:10px;">   
             <!-- 隐藏 -->
             <input type="hidden" name="id" id="jlsxlcId" value="${vo.id}"/>
             <input type="hidden" name="fbrenId" id="fbrenId" value="${vo.fbrenId}" />
             <input type="hidden" name="ssbmId" value="${vo.ssbmId}"/>
             <input type="hidden" name="zt" id="zt" value="2"/><!-- 1暂存2处理中3已完结 -->
        ...
        <input type="hidden" name="ssbmId" value="${vo.ssbmId}"/>
             ...
             <div class="Tableh2"><strong>筛选信息</strong>
                <div class="btnbox" style="float:right;margin:0px 0px;">
                     ...
                     <button type="button" class="btn btn_success"  onclick="location='<%=ctx%>/zp/zpjlsxlc/initDbrw.do'">返回</button>
                </div>
            </div>
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
               <tr>
                 ...
                 <td width="35%">
                 <input type="text" class="input02" style="width:100%" id="jlsxmc"
					  name="jlsxmc" value="${vo.jlsxmc }" readonly>
                 </td>
    ...
    <div title="正文" data-options="" style="overflow:auto;padding:10px;">  
    	<input type="hidden"  id="htmlStr" name="htmlStr">
         <div id="htmlStr1" class="easyui-texteditor" style="height:380px;padding:10px">
    		${vo.htmlStr }
		</div>
    </div>   
            ...
            <div class="Centerbox" style="">
              ...
              <tr>
                  ...
                  <div class="btnbox" style="float:right;margin:0px 0px;">
                        ...
                        <button type="button" class="btn btn_success"  onclick="location='<%=ctx%>/zp/zpjlsxlc/initDbrw.do'">关闭</button></div>
                  </div>
              	</td>
              </tr>
              <tr>
                     ...
                     <table id="hjyjxx" style="width: 100%;" >
						<thead>
							<tr>
								...
								<th data-options="field:'czyj', halign:'center',width:300,formatter:formatYj">办理人意见</th>
							</tr>
       ...
       <table width="100%" border="0" cellspacing="10" cellpadding="0">
           <tr><td>
               <div class="Centerbox">
                  ...
                  <table width="100%" border="0" cellspacing="6" cellpadding="0">
                     <tr><td>
                        <input name="hjID" type="radio" value="1" onclick="showBm(this.value)" style="margin:2px 5px 0px 15px;">送部门内审核
                        <input name="hjID" type="radio" value="2" onclick="showBm(this.value)" style="margin:2px 5px 0px 15px;">送其他部门会签
                        <input name="hjID" type="radio" value="3"  checked="checked" style="margin:2px 5px 0px 15px;">送结束
                     </td>
                     </tr>
                  </table>
                  </div>
                  ...
                  <div style="border: 2px;"> 
                    	 ...
                    	 <ul id="tree" class="ztree" style="width:230px; overflow:auto;height: 100px;display:none;"></ul>
                  </div>
                  <div style="border: 2px;"> 
	                  <table>
...
<div id="sxyjtjDialog" class="easyui-dialog" title="筛选意见" style="width:400px;height:200px;"   
   ...
   <form id="sxyjForm" method="post" style="width:100%;height:100%">  
   		<input name="czjl" id="czjl" type="radio" value="1" checked="checked" 
        style="margin:2px 5px 0px 15px;">审核同意
        <input name="czjl" id="czjl" type="radio" value="2"  
        style="margin:2px 5px 0px 15px;">不同意    
