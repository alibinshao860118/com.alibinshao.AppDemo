...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctxStatic}/js/modules/htgl/htHtxx/xqHtxxList.js"></script>
	</head>
	<body>
		...
		<sys:toolbar showExportExcel="true" exportFileName="合同信息表数据列表"
			...
			<div class="layui-btn-group">
				<sys:button onclick="edit();" btnClass="layui-btn-small layui-btn-normal"><i class='layui-icon'>&#xe642;</i>续签</sys:button>
				<sys:button onclick="delete_();" btnClass="layui-btn-small layui-btn-danger"><i class='layui-icon'>&#xe640;</i>终止</sys:button>
			</div>
		</sys:toolbar>
		...
		<div id="dialog"  style="display: none;padding: 10px 10px 0 40px; ">
			<sys:form id="dialogForm">
				...
				<input type="hidden" id="xqFlag" name="xqFlag"/>
				<sys:formRow>
					<sys:formItem lable="姓名" lableStyle="width:85px;" isRequired="true">
						<sys:input id="xm" inputStyle="width:150px;" readOnly="true"></sys:input>
			   		</sys:formItem>
			   ...
			   <sys:formRow>
					...
					<sys:formItem lable="固定期限" lableStyle="width:150px" itemStyle="width:125px;">
			   ...
			   <sys:formRow>
					<sys:formItem lable="续签日期" lableStyle="width:85px">
						<sys:inputDate id="xqRq" inputStyle="width:150px;"></sys:inputDate>
			   		</sys:formItem>
			  </sys:formRow>
			  <sys:formRow>
